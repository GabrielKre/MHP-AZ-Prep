# MHP-AZ-Prep AZ-900 (Microsoft Azure Fundamentals) Questions & Answers

## Table of Contents

### If you plan to deploy a web application in the Azure platform as a service solution of Azure Web Apps, then the platform will have the ability to scale automatically?
...
### A set of RBAC permissions have been assigned to a resource group. Would the resources in the resource group automatically inherit the RBAC permissions assigned to the resource group?
...
### You have an Azure environment that contains 10 virtual networks and 100 virtual machines You need to limit, filter and monitor the inbound traffic to all the Azure virtual networks. What should you create?
...
- [ ] A VPN for FinServer and a virtual natwork gateway for each other server.
...
### Your company has on-premises network includes a large number of servers. They would like to make extra resources available to their users, while keeping capital expenditure to a minimum. You are required to make recommendations that should be included in the overall solution. Solution: You should endorse the use of a hybrid cloud as part of the solution. Does the solution meet the goal?
...
### Your company has an Azure Active Directory (Azure AD) environment. Users occasionally connect to Azure AD via the Internet. You have been tasked with making sure that users who connect to Azure AD via the internet from an unidentified IP address, are automatically encouraged to change passwords. Solution: You configure the use of Azure AD Conditional Access. Does the solution meet the goal?
